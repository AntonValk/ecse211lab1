...
public class OdometryCorrection extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			//Intensity at line is < 155.
			if(color[0] < 155 && lastColor < 160) continue; //Only register line when the last measurement DID NOT measure a line
			lastColor = color[0];

			// put your correction code here
			
			if(color[0] < 155) //Detected black
			{
